...
class SystemLauncher:
    ...
    def create_mode_buttons(self, parent):
        ...
        # Web Mode Button
        web_frame = tk.Frame(
            buttons_frame, bg="white", relief="raised", bd=2, padx=20, pady=15
        )
...
🔄 Aturan Sekuensial & Paralel
    ...
    def launch_web_mode(self):
        ...
        try:
            ...
            self.root.after(
                3000, lambda: self.open_browser_and_close_loading(loading_window)
            )
    ...
    def launch_desktop_mode(self):
        ...
        try:
            ...
            desktop_app = ExpertSystemGUI(desktop_root)  # noqa: F841
            ...
            error_msg = f"Gagal memulai web mode:\n{str(e)}"
    ...
    def launch_cli_mode(self):
        ...
        try:
            ...
            if os.name == "nt":  # Windows
                subprocess.Popen(
                    ["cmd", "/c", "start", "cmd", "/k", python_path, cli_path]
                )
            else:  # Linux/Mac
                subprocess.Popen(["gnome-terminal", "--", python_path, cli_path])

            messagebox.showinfo(
                "CLI Mode", "Command Line Interface telah dibuka di terminal baru!"
            )
    ...
    def show_loading_window(self, message):
        ...
        # Loading content
        tk.Label(loading, text=message, font=("Arial", 12), pady=20).pack()
        ...
        tk.Label(loading, text="Please wait...", font=("Arial", 9), fg="gray").pack()
