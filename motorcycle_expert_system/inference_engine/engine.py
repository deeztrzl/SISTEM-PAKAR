...
class InferenceEngine:
        ...
        while iteration < max_iterations:
            ...
            for rule in self.rules:
                ...
                if can_fire:
                    ...
                    elif conclusion.startswith('K'):  # Sequential rule (symptom as conclusion)
        ...
        for rule in self.rules:
            if rule['then'].startswith('A'):  # Hanya untuk kerusakan
                ...
                if matching_conditions > 0:
                    ...
                    similarity = matching_conditions / (total_conditions + len(symptom_list) - matching_conditions)
                    # CF dikalikan dengan similarity untuk partial matching
                    adjusted_cf = rule['cf'] * similarity * 0.5  # Reduced confidence for partial match
    ...
    def create_category_based_diagnosis(self, symptom_list):
        ...
        engine_symptoms = ['K05', 'K06', 'K07', 'K08', 'K09', 'K13', 'K14', 'K16', 'K17', 'K20', 'K34']
    ...
    def explain_reasoning(self, diagnosis_result):
        ...
        explanation.append(f"Gejala input: {', '.join(diagnosis_result['input_symptoms'])}")
        explanation.append("")
        ...
        for i, step in enumerate(diagnosis_result['inference_path'], 1):
            ...
            explanation.append(f"  Kondisi: {', '.join([self.symptoms.get(c, c) for c in step['conditions']])}")
        ...
        for i, diag in enumerate(diagnosis_result['diagnosis'], 1):
            ...
            explanation.append(f"   Tingkat Kepercayaan: {diag['confidence_percentage']}%")
...
if __name__ == "__main__":
    ...
    test_symptoms = ["K01", "K02", "K03"]  # Motor tidak hidup, starter tidak fungsi, lampu tidak menyala
